...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
	...
	// should be attentioned in the lab which the fifth param will alyways be 0 because we don't have enough registers
	// so we decide to make the first param an array
	uint32_t arglist[5];
